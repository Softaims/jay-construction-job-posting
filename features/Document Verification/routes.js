...
import {  submitContractorDocuments, verifyContractorDocuments} from "./controllers.js";
...
router.post("/verify-contractor-documents",authMiddleware,authorizeMiddleware("admin"),validate(verifyContractorDocumentsValidator),verifyContractorDocuments)
