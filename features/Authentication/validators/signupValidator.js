...
export const subcontractorSchema = z.object({
  ...
  services_offered: z
    .array(z.string({ required_error: "Service name is required" }))
...
export const jobSeekerSchema = z.object({
  ...
  trade: z
    ...
    .min(2, "Trade must be at least 2 characters long"),

  travel_radius_km: z
    .number({ required_error: "Travel radius is required" })
    .min(1, "Travel radius must be at least 1 km"),
  ...
  id_document: z.string().url("ID document must be a valid URL").optional(),
});
